...
public class ChatRoomSelectServiceImpl implements ChatRoomSelectService {
   ...
   public String getEachChat(String name,int chatRoomNum) {
      ...
      eachHtml += "<div style=\"position: absolute;width: 300px;height: 530px;background: white;margin: 0px;left: 35%;top: 10%;border-radius:10px;\" class = \'chatRoom\'id = \'chatRoom" + chatRoomNum + "\'>" + chatRoomScript(chatRoomNum)
            + "<div style=\"width: 300px;height: 60px;background: #555a9c;border-radius : 10px;\" class = \'roomInfo\' id = \'roomInfo" + chatRoomNum + "\'>" + roomInfo(chatRoomNum) + "</div>"
      ...
      eachHtml += "</div><div style=\"width: 300px;height: 100px;\" class = \'addContentDiv\'>" 
            + "<textarea style=\"height:75px;margin: 5px;float: left;\" id = \'textA" + chatRoomNum + "\'class = \'textA\' cols=\'30\' rows=\'5\'></textarea>" 
   ...
   public String roomInfo(int chatRoomNum) {
      ...
      roomInfoHtml =  "<div class = \'roomInfoDiv\'>"
            ...
            +               "<img src=\"resources/img/minimi.png\" id=\"chatRoom"+chatRoomNum+"\" onclick=\"minimiEachChat('chatRoom"+chatRoomNum+"')\"class =\'exit\' value=\'"+chatRoomNum+"\'><br>"
            +            "</div>"
            +         "</div>"
            +       "</div>";
      return roomInfoHtml;
   ...
   public String chatRoomCon(ChatContentDTO chatContentDTO,String name) {
      ...
      if(!name.equals(chatContentDTO.getMember()))
         return "<div class = \'chatConThumb\'style=\"padding: 10px;float: left;width: 50px;height: 50px;\"><img src = \'resources/img/thumb.jpg\'></div>"
               +   "<div class = \'chatMsg\'>"
               +       "<div class=\'chatConDiv\' style='padding-left: 20px;float: left;'>"
